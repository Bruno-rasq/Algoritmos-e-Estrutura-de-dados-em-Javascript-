...
sumOfIntervals([[1,2], [2,3], [3,4]])
sumOfIntervals([[1,4], [7,10], [3,5]])
...
mostFrequentWord("cc bb aa dd cc")
mostFrequentWord("the quick brown fox jumps over the lazy dog")